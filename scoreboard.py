...
class Scoreboard:
    ...
    def prep_score(self):
        ...
        if self.isfullscreen == 1:
            self.score_rect.right = 1300-20
        else:
            self.score_rect.right = self.screen_rect.right - 20  # 保持右侧20像素的边距
    ...
    def prep_high_score(self):
        ...
        if self.isfullscreen == 0:
            ...
            self.high_score_rect.centerx = 650
    ...
    def prep_blood(self):
        ...
        blood_str = f"blood/full blood:{str(rounded_blood)}/{str(rounded_full_blood)}"
        ...
        self.blood_rect.top = self.score_rect.bottom + 20
    def prep_ships(self):
        self.ships = Group()
